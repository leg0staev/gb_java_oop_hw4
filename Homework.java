...
public class Homework {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*** создам немного яблок и апельсинов ***");
        ...
        System.out.println("*** создам ящики для яблок и апельсинов ***");
        ...
        System.out.println("*** разложу все фрукты по ящикам ***");
        ...
        System.out.printf("*** сравню %s и %s по весу ***\n", box1, box2);
        ...
        System.out.printf("*** пересыплю фрукты из %s в %s ***\n", box3, box1);
        box3.transferTo(box1);
        System.out.println();

        System.out.printf("*** сравню еще раз %s и %s по весу ***\n", box1, box2);
...
class Box<T extends Fruit> {
    ...
    public void addFruit(T fruit) {
        fruits.add(fruit);
        System.out.printf("в %s длбавден фрукт %s\n", name, fruit);

        // if (type.getSimpleName().equals(fruit.getClass().getSimpleName())) {
        //     fruits.add(fruit);
        //     System.out.printf("в %s длбавден фрукт %s\n", name, fruit);
        // } else {
        //     System.out.printf("Нельзя добавить %s в ящик с %s\n",
        //     fruit.getName(), type.getSimpleName());
        // }
    }
